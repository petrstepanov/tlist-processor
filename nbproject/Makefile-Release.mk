...
${OBJECTDIR}/src/AppSettings.o: src/AppSettings.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppSettings.o src/AppSettings.cpp
...
${OBJECTDIR}/src/FittingFunctions.o: src/FittingFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FittingFunctions.o src/FittingFunctions.cpp

${OBJECTDIR}/src/Geometry.o: src/Geometry.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Geometry.o src/Geometry.cpp

${OBJECTDIR}/src/GraphicsHelper.o: src/GraphicsHelper.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GraphicsHelper.o src/GraphicsHelper.cpp

${OBJECTDIR}/src/HistProcessor.o: src/HistProcessor.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HistProcessor.o src/HistProcessor.cpp

${OBJECTDIR}/src/StringUtils.o: src/StringUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StringUtils.o src/StringUtils.cpp

${OBJECTDIR}/src/TlistProcessorFrame.o: src/TlistProcessorFrame.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TlistProcessorFrame.o src/TlistProcessorFrame.cpp
